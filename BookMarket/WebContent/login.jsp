            		...
            		<div class="col-lg-8 col-xl-7">  
            			<form class="form-signin" action="loginLoginProcess.jsp" method="post">
          					...
          					<div class="row" style="width:500px; flex-direction:row; margin-bottom:200px;">
          						...
          						<button class="btn btn-sm btn-light" style="width:130px; height:30px; margin-left:12px;" type="submit"><%= sign_in %></button>
 
          					</div>
        				</form>  
        				<form class="form-signin" action="loginSignUp.jsp" method="post">
          					<div class="row" style="width:500px; flex-direction:row; margin-bottom:200px;">
          						<button class="btn btn-sm btn-dark" style="width:130px; height:30px; margin-left:12px" type="submit"><%= sign_up %></button>
          					</div>
        				</form>      			
            		</div>
            </div>
